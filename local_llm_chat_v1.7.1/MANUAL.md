...
**v1.7.1の一部機能は LM Studio v0.4.0以降が必要です:**
- モデル比較機能（複数モデルの同時ロード）
...
> **推奨**: Local LLM Chat v1.7.1 の全機能を使用するには **LM Studio v0.4.0以降** を使用してください。
