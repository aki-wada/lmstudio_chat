...
2. **local_llm_chat_v1.7.0.html をブラウザで開く**
...
### Q: 複数のモデルを同時に使えますか？
A: LM Studioで複数モデルをロードし、ドロップダウンで切り替え可能です。v1.7.0では📊比較機能で2つのモデルを同時に使えます。
